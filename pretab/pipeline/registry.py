...
NUMERICAL_METHODS = {
    ...
    "ple": (PLETransformer, ["output_dim", "task"]),
    "custombin": (CustomBinTransformer, ["output_dim"]),
    "rbf": (
        RBFExpansionTransformer,
        ["output_dim", "gamma", "use_decision_tree", "task", "strategy"],
    ),
    "relu": (
        ReLUExpansionTransformer,
        ["output_dim", "use_decision_tree", "task", "strategy"],
    ),
    "sigmoid": (
    ...
    "tanh": (
        ...
        ["output_dim", "scale", "use_decision_tree", "task", "strategy"],
    ),
